...
class ClientPageNotFoundView(TemplateView):
...
class ClientContactCreateView(ClientMixin, SuccessMessageMixin, CreateView):
    ...
    success_url = '/'
    success_message = 'contact successfully sent'
...
class ClientSubscriberCreateView(SuccessMessageMixin, CreateView):
    template_name = "clienttemplates/clientbase.html"
...
class AdminBlogCreateView(AdminMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        html_content = render_to_string(
            'clienttemplates/clientblogdetail.html')
...
class AdminSliderDeleteView(AdminMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        messagesubsccess(self.request, self.success_message)
